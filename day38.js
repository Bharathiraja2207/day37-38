...
db.topics.insertMany([
    {
      "topic_id": 1,
      "topic": "HTML",
      "topic_date":ISODate("2021-02-15T06:31:15.000Z"),
    },
    {
      "topic_id": 2,
      "topic": "CSS",
      "topic_date":ISODate("2021-10-01T06:31:15.000Z"),
    },
    {
      "topic_id": 3,
      "topic": "Javascript",
      "topic_date": ISODate("2021-06-15T06:31:15.000Z"),
    },
    {
      "topic_id": 4,
      "topic": "React",
      "topic_date":ISODate("2021-01-29T06:31:15.000Z"),
    },
    {
      "topic_id": 5,
      "topic": "NodeJs",
      "topic_date":ISODate("2021-10-15T06:31:15.000Z"),
    },
  ]);
...
//3Find all the company drives and students who are appeared for the placement
...
//4Find the number of problems solved by the user in codekata
    db.users.aggregate([
      {
          $lookup:{
              from: "codekata",       
...
//5Find all the mentors with who has the mentee's count more than 15
...
db.mentors.aggregate([
  ...
  {   
      $project:{
          _id : 1,  
          mentor_name:1,
          user_name:"$user_s.name",
          
      }
  }, 
  
{
  $match: {mentor_name:"mentor1"}
...
//6Find the number of users who are absent and task is not submitted  between 15 oct-2020 and 31-oct-2020
...
db.users.aggregate([
  ...
  }, { $match : { present : false,submitted:false,date:{$gt:new Date("2021-10-15"),$lt: new Date("2021-10-31")}} },{ 
    $group: { 
        _id: null, 
        total: { 
            $sum: 1 
